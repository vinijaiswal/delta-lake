...
###TIP: To increase spark executor memorey, uncomment and run the command below with the memory value of your choice
...
##Save two delta tables for comparing merge operations
customersDF.write.partitionBy('first_sales_date').format('delta').save('/temp/data/customers1')
customersDF.write.partitionBy('first_sales_date').format('delta').save('/temp/data/customers2')
